// base-nft-marketplace/scripts/security-audit.js
const { ethers } = require("hardhat");
const fs = require("fs");

async function performSecurityAudit() {
  console.log("Performing security audit for Base NFT Marketplace...");
  ...
  try {
    ...
    // Сохранение отчета
    const auditFileName = `security-audit-${Date.now()}.json`;
    ...
    console.log("NFT marketplace security audit completed successfully!");
